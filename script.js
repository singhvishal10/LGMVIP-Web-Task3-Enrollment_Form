...
function data(){
    ...
    if(element[5].value !=""){
     ...
     if(element[6,7].checked){skills.innerHTML="SKILLS: HTML,CSS";}
     if(element[6,7,8].checked){skills.innerHTML="SKILLS: HTML,CSS,JAVASCRIPT";}
     if(element[7,8].checked){skills.innerHTML="SKILLS: CSS,JAVASCRIPT";}
     if(element[6,8].checked){skills.innerHTML="SKILLS: HTML,JAVASCRIPT";}
